...
requirements = python3,kivy,https://github.com/kivymd/KivyMD/archive/master.zip, materialyoucolor, exceptiongroup, asyncgui, asynckivy, pilow
...
#       [app]
#       title = My ok # This is not a comment, it is part of the title.
#
